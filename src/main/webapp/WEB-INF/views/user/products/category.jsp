							...
							<div class="col-xs-5 col-sm-8 col-lg-9 hidden-xs">
								<div class="view-mode">
									...
									<div class="tt hidden-sm hidden-xs inline-block">
										<span class="hidden-sm hidden-xs"> (${ cate.size() } sản phẩm) </span>
									</div>
								</div>
							</div>
							<div
										...
										<div class="product-info a-center">
											...
											<div class="price-box clearfix">
												...
												<div class="special-price">
													<span class="price product-price"><fmt:formatNumber value="${item.price}"
											currencySymbol="VND" type="currency" /></span>
												</div>
											</div>
