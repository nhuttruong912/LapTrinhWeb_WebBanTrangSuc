			...
			<div class="span9">
				...
				<div class="row">
					<div class="span8">
						<div class="well">
							<br />
							<form:form action="${pageContext.request.contextPath}/quan-tri/them-san-pham" method="POST"
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:select path="id_category" items="${categories}" itemValue="id"
											itemLabel="name" />
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									<div class="controls">
										<input type="submit" name="submitAccount" value="Tạo sản phẩm mới"
